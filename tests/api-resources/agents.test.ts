...
describe('resource agents', () => {
  ...
  test('claim: only required params', async () => {
    const responsePromise = client.agents.claim({ claim_token: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('claim: required and optional params', async () => {
    const response = await client.agents.claim({ claim_token: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e' });
  });

  test('generate: only required params', async () => {
    const responsePromise = client.agents.generate({ prompt: 'prompt' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
