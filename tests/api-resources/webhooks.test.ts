...
describe('resource webhooks', () => {
  test('create: only required params', async () => {
    const responsePromise = client.webhooks.create({ events: ['string'], url: 'url' });
  ...
  test('create: required and optional params', async () => {
    const response = await client.webhooks.create({ events: ['string'], url: 'url' });
  });
  ...
  test('listActiveForEvent: only required params', async () => {
    const responsePromise = client.webhooks.listActiveForEvent({ event_type: 'event_type' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('listActiveForEvent: required and optional params', async () => {
    const response = await client.webhooks.listActiveForEvent({ event_type: 'event_type' });
  });
});
